  ...
  def install_tools(self):
    while True:
      ...
      for tool_name in tool.names:
        print (f" \033[01;32m[ \033[01;37m{num} \033[01;32m] \033[1;35minstall \033[01;32m{tool_name}\033[00m")
        num+=1
      print("")
      logo.back()
  ...
  def category(self):
    while True:
      ...
      for cat in tool.category:
        print (f"  \033[01;32m[ \033[01;37m{num} \033[01;32m] \033[1;35m{tool.category_data[cat]}\033[00m")
        num+=1
      print("")
      logo.back()
      cmd=input("\033[1;36m ##> \033[00m")
            ...
            while True:
              ...
              for i in tool.names:
                if tool.category[int(cmd)-1] in tool.data[i]["category"]:
                  ...
                  print(f" \033[01;32m[ \033[00m{cnt} \033[01;32m] \033[1;35minstall \033[01;32m{tool.data[i]['name']}\033[00m")
                  cnt+=1
              print("")
              logo.back()
    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection:
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/hacker19"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/Saurabhyadav19/hacker19.git "+system.home+"/hacker19")
            if os.path.exists(system.home+"/hacker19/install.aex"):
              os.system("cd "+system.home+"/hacker19 && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/hacker19"):
              ...
              os.system("git clone https://github.com/Saurabhyadav19/hacker19.git "+system.home+"/hacker19")
            if os.path.exists(system.home+"/hacker19/install.aex"):
              os.system("cd "+system.home+"/hacker19 && sh install.aex")
              if os.path.exists(system.bin+"/hacker19") and os.path.exists(system.conf_dir+"/hacker19"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall hacker19":
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/hacker19")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/hacker19")
        else:
          os.system("rm -rf "+system.bin+"/hacker19")
          os.system("rm -rf "+system.conf_dir+"/hacker19")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/hacker19/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/hacker19/core/cat.json") as cat_file:
